...
x_transformer_file = open("/home/hvtham/classification/classification/data/thamTest/x_transformer.pkl", "rb")
x_transformer = pickle.load(x_transformer_file)

y_transformer_file = open("/home/hvtham/classification/classification/data/thamTest/y_transformer.pkl", "rb")
y_transformer = pickle.load(y_transformer_file)

ch2_file = open("/home/hvtham/classification/classification/data/thamTest/ch2.pkl", "rb")
ch2 = pickle.load(ch2_file)

estimator_file = open("/home/hvtham/classification/classification/data/thamTest/model.pkl", "rb")
